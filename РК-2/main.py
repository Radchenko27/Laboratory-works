...
def Solution1(one_to_many):
    print('Задание А1')
    one_to_many_sort = sorted(one_to_many, key=itemgetter(0))
    return one_to_many_sort


def Solution2(one_to_many):
    print('Задание А2')
    ...
    return one_to_many2_sort


def Solution3(many_to_many):
    print('Задание А3')
...
def main():
    ...
    print(Solution1(one_to_many))
    print(Solution2(one_to_many))
    print(Solution3(many_to_many))
